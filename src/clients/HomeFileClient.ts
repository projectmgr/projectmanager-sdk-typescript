...
export class HomeFileClient {
   ...
   */
  uploadHomeFile(filename: string, xintegrationname?: ): Promise<AstroResult<FileDto>> {
   ...
   * @param filename The full path of a file to upload to the API
   */
  uploadHomeFileToFolder(folderId: string, filename: string, xintegrationname?: ): Promise<AstroResult<FileDto>> {
