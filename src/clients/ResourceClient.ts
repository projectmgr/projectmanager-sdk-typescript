...
export class ResourceClient {
   ...
   */
  createResource(body: ResourceCreateDto, xintegrationname?: ): Promise<AstroResult<ResourceDto>> {
   ...
   */
  queryResources(xintegrationname?: , top?: number, skip?: number, filter?: string, select?: string, orderby?: string, expand?: string): Promise<AstroResult<ResourceDto[]>> {
    const url = `/api/data/resources`;
    const options = {
      params: {
        '$top': top,
   ...
   */
  updateResource(resourceId: string, body: ResourceUpdateDto, xintegrationname?: ): Promise<AstroResult<ResourceDto>> {
   ...
   * @param xintegrationname The name of the calling system passed along as a header parameter
   */
  retrieveResource(resourceId: string, xintegrationname?: ): Promise<AstroResult<ResourceDto>> {
    const url = `/api/data/resources/${resourceId}`;
