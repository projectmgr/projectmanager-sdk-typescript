...
export class DashboardClient {
   ...
   */
  retrieveDashboardUserSettings(type: string, xintegrationname?: ): Promise<AstroResult<DashboardSettingDto>> {
   ...
   */
  createorUpdateUserDashboardSettings(body: DashboardSettingCreateDto, xintegrationname?: ): Promise<AstroResult<DashboardSettingDto>> {
