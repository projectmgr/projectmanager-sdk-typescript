...
export class WorkSpaceClient {
   ...
   *
   */
  retrievethecurrentworkspace(): Promise<AstroResult<WorkSpaceDto[]>> {
   ...
   */
  updatesettingsforthecurrentworkspace(body: WorkspaceSettingsUpdateDto): Promise<AstroResult<WorkSpaceDto>> {
